import DynamicalSystemsInvolvingRelationsCorrespondencesLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "dynamical-systems-involving-relations-correspondences-lemma theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
